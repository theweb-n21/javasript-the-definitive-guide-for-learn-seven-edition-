/** 4.7.2 Operand and Result Type
 ...
 to) a value of a specific type. The Types column in 
Table 4-1 specifies
 operand types (before the arrow) and result type (after the arrow) for
 the operators.
 JavaScript operators usually convert the type (see 
§3.9) of their
...
operands, but the expression "3" * "5" is legal because JavaScript
 ...
 listed in 
Table 4-1 expect an operand of type lval. lvalue is a
